...
public interface TradingWebService {
    ...
    /**
     * Returns a list of stock options where the company name contains the string specified in the 'partOfCompanyName' parameter
     */
    @WebMethod
    ...
    /**
     * Returns the price per share effective for selling the shares.
     */
    @WebMethod
    ...
    /**
     * Returns the price per share effective for the buying transaction.
     */
    @WebMethod
